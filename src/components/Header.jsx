export default function Header({ channelName = "YouTube Channel" }) {
  return (
    <header className="text-center py-6 bg-red-600 text-white shadow-md flex flex-col items-center">
      ...
      <p className="text-red-200 mt-1 text-lg">Live stats from YouTube Data API</p>
    </header>
  );
}
